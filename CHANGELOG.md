# ToDesktop 更新说明 (Release Notes)

## 🏷️ 版本号: v0.2.3

ToDesktop `v0.2.3` 是一次具有重大里程碑意义的跨版本兼容与防御机制更新。我们成功实现了对 **macOS 14.0+ (Sonoma)** 新系统的完美防穿透支撑，同时为 **macOS 13.0 及以下系统** 提供了高保真的防误触优化，打造了无缝契合的多版本并行运行架构。
...
*   **双芯片通用版 (Intel + Apple Silicon)**: `ToDesktop_v0.2.3_universal.dmg` (已随仓库一并上传)
